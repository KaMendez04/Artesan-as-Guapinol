    ...
    <div className="min-h-screen bg-background text-gray-900 dark:text-white animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-backwards">
      <div className="mx-auto max-w-3xl p-4 md:p-8">
        ...
        <div className="rounded-3xl p-4 md:p-6">
          <div className="mt-5 rounded-2xl border border-border/50 bg-white/60 dark:bg-white/5 backdrop-blur-md px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-2xl border border-border/50 bg-white/60 dark:bg-white/5 px-3 py-2 text-sm font-medium
                           text-gray-700 dark:text-white transition hover:bg-white/80 dark:hover:bg-white/10 backdrop-blur-sm"
              >
                <ChevronDown
                  size={15}
          ...
          <div className="mt-5 rounded-3xl border border-border/50 bg-white/60 dark:bg-white/5 backdrop-blur-md p-4 md:p-5 overflow-hidden">
                    ...
                    >
                      ...
                      <div className="text-right">
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-xl border border-border/50 bg-white/60 dark:bg-white/5 p-1.5 transition hover:bg-white/80 dark:hover:bg-white/10 backdrop-blur-sm md:p-2"
                        >
